...
public class String01Main {
	...
	public static void main(String[] args) {
		...
		str1.concat(str2);
		System.out.println("str1 => " +str1); // 변경안됨. 변경불가 immutable
		str1 = str1.concat(str2); // 이거는 덮어쓰는거기 때문에 문자열 변경됨.
...
//		System.out.println(str1.charAt(20));  StringIndexOutOfBoundsException
		...
		System.out.println(str1.indexOf('c')); // 없으면 -1 출력됨.
...
//		strings = str5.split("|"); // 이렇게 하몀ㄴ 결과 이상해짐
		strings = str5.split("\\|");
		System.out.println(Arrays.toString(strings));
		...
		System.out.println(str10.replace("Language", "Java")); // 매칭 되는 것을 모두 치환
