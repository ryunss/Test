...
//		System.out.println(test2.MIN); // 다중상속의 문제점@!
		System.out.println(TestInterface.MIN);	// static 인점을 활용해서 클래스.ㅇㅇ 으로 사용한다!		
...
interface TestInterface{
	...
	int MAX = 100; // public static final 생략됨. 생략해도 가능.
//	private static final String JAVA_STRING = "Java"; // 에러. private 에러임. public 만 가능!!!
...
class TestImpl2 implements TestInterface, TestInterface2{ 
	...
	// 양쪽 부모의 동일 시그니쳐 추상메소드는 하나만 오버라이딩 된다.
	@Override
	public void testAAA() {
		System.out.println("testAAA");
	}
