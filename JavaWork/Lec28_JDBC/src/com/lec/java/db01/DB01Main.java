...
//				String no = rs.getString("mb_no");   // mb_no 컬럼값을 String 으로 리턴
...
//			}
			...
			while(rs.next()) {
				...
				LocalDateTime dateTime = rs.getObject("mb_birthdate", LocalDateTime.class);  // mb_birthdate 값을 LocalDateTime 으로 받아옴
