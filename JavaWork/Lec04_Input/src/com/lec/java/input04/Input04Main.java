...
public class Input04Main {
	...
	public static void main(String[] args) {
		...
		String in1 = sc.next();
		int i1 = Integer.parseInt(in1); // 문자열 in1 을 int로 변환
		String in2 = sc.next();
		int i2 = Integer.parseInt(in2); // ↔ sc.nextInt()
		String in3 = sc.next();
		int i3 = Integer.parseInt(in3);
		
//		System.out.println("합: " + (in1 + in2 + in3)); // 102030 으로 출력됨.
		System.out.println("합: " + (i1 + i2 + i3)); // 60 출력.
