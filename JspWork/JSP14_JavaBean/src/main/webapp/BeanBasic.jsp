...
<jsp:useBean id="person2" class="com.lec.beans.Person">
	...
	<jsp:setProperty name="person2" property="id" value="33"/>	
...
<jsp:useBean id="student1" class="com.lec.beans.Student">
	<jsp:setProperty name="student1" property="name" value="김사과"/>
	<jsp:setProperty name="student1" property="age" value="19"/>
	<jsp:setProperty name="student1" property="grade" value="3"/>
	<jsp:setProperty name="student1" property="gender" value="여"/>
</jsp:useBean>
...
<body>
	...
	<%-- <jsp:setProperty property="weight" name="person1" value="남" /> 에러 --%>
